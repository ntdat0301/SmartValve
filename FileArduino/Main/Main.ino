...
#define WIFI_SSID "Mynk"   //Thay wifi và mật khẩu
#define WIFI_PASSWORD "chutnuanoi"

#define itr1 D2 // button 1
#define itr2 D3 // button 2
#define itr3 D4 // button 3

#define VAN1 D5 // Van 1
#define VAN2 D6 // Van 2
#define VAN3 D7 // Van 3
#define LED D1 // Led báo đã setup xong
...
void setup() {
  ...
  digitalWrite(VAN1,1);  /// Mức 1 là tắt, mức 0 là bật
  digitalWrite(VAN2,1);
  digitalWrite(VAN3,1);
  digitalWrite(LED,1);
  ...
  Firebase.stream("/Device/"+IDthietbi);  // Hàm này để khởi tạo theo dõi database ( Để xem có sự thay đổi nào trong database không)
  ...
  digitalWrite(LED,0); // Bật đèn báo Hệ thống đã setup xong, Bắt đầu chạy chương trình điều khiển và cập nhật dữ liệu
  /*-----------------------------------------------------------------------------------------------------*/
...
void SetParameter()
  {
    /* Nhiệm vụ :
      ...
      */
      ...
      Firebase.setString("Device/"+IDthietbi+"/name","Device1");
      /*---------Nhiệm vụ 2_Set trạng thái các Van lúc đầu LÀ OFF--------*/
      Firebase.setString("Device/"+IDthietbi+"/VAN1/Status","OFF");
      Firebase.setString("Device/"+IDthietbi+"/VAN2/Status","OFF");
      Firebase.setString("Device/"+IDthietbi+"/VAN3/Status","OFF");
      /*---------Nhiệm vụ 3_Set trạng thái hẹn giờ lúc đầu của 3 van là OFF----------*/
      Firebase.setString("Device/"+IDthietbi+"/VAN1/stsSW","OFF");
      Firebase.setString("Device/"+IDthietbi+"/VAN2/stsSW","OFF");
      Firebase.setString("Device/"+IDthietbi+"/VAN3/stsSW","OFF");
      /*---------Nhiem vu 4_Set trạng thái hẹn lúc đầu của 3 van------------ */
      Firebase.setString("Device/"+IDthietbi+"/VAN1/Hour_B","0");
      Firebase.setString("Device/"+IDthietbi+"/VAN1/Hour_T","0");
      Firebase.setString("Device/"+IDthietbi+"/VAN1/Minute_B","0");
      Firebase.setString("Device/"+IDthietbi+"/VAN1/Minute_T","0");

      Firebase.setString("Device/"+IDthietbi+"/VAN2/Hour_B","0");
      Firebase.setString("Device/"+IDthietbi+"/VAN2/Hour_T","0");
      Firebase.setString("Device/"+IDthietbi+"/VAN2/Minute_B","0");
      Firebase.setString("Device/"+IDthietbi+"/VAN2/Minute_T","0");

      Firebase.setString("Device/"+IDthietbi+"/VAN3/Hour_B","0");
      Firebase.setString("Device/"+IDthietbi+"/VAN3/Hour_T","0");
      Firebase.setString("Device/"+IDthietbi+"/VAN3/Minute_B","0");
      Firebase.setString("Device/"+IDthietbi+"/VAN3/Minute_T","0");
    }
void BatSuKien1()
{ 
      ...
      if(dateTime.valid) // Kiem tra dateTime.valid truoc khi dua ra gia tri thoi gian
        {
          ...
          if ((Firebase.getString("Device/"+IDthietbi+"/VAN1/stsSW"))== ("ON"))
            {
              GetInfo_HandM_DB("VAN1");
              }
          else 
          if ((Firebase.getString("Device/"+IDthietbi+"/VAN2/stsSW"))== ("ON"))
            {
              GetInfo_HandM_DB("VAN2");
              }
          else
          if ((Firebase.getString("Device/"+IDthietbi+"/VAN3/stsSW"))== ("ON"))
            {
...
void GetInfo_HandM_DB(String van)
  {
    ...
    String Hb= Firebase.getString("Device/"+IDthietbi+"/" + van + "/Hour_B");
    String Mb= Firebase.getString("Device/"+IDthietbi+"/" + van + "/Minute_B");

    String Ht= Firebase.getString("Device/"+IDthietbi+"/" + van + "/Hour_T");
    String Mt= Firebase.getString("Device/"+IDthietbi+"/" + van + "/Minute_T");
    ...
    if ( stsVan1 != stsVan1_Old)
      {
        if (stsVan1 ==true)
          {
            Firebase.setString("Device/"+IDthietbi+"/VAN1/Status","ON");
          }
          else
          {
            Firebase.setString("Device/"+IDthietbi+"/VAN1/Status","OFF");
      ...
      if ( stsVan2 != stsVan2_Old)
      {
        if (stsVan2 ==true)
          {
            Firebase.setString("Device/"+IDthietbi+"/VAN2/Status","ON");
          }
          else
          {
            Firebase.setString("Device/"+IDthietbi+"/VAN2/Status","OFF");
       ...
       if ( stsVan3 != stsVan3_Old)
      {
        if (stsVan3 ==true)
          {
            Firebase.setString("Device/"+IDthietbi+"/VAN3/Status","ON");
          }
          else
          {
            Firebase.setString("Device/"+IDthietbi+"/VAN3/Status","OFF");
